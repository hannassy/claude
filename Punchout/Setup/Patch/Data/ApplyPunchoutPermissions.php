...
class ApplyPunchoutPermissions implements DataPatchInterface, PatchRevertableInterface
{
    private const TABLE_NAME_ELEMENT = 'silk_access_element';
    private const TABLE_NAME_ROLE = 'silk_access_role_right';
    private const MODULE_NAME = 'Tirehub_Punchout';
    ...
    /** @inheritDoc */
    public function apply(): ApplyPunchoutPermissions
    {
